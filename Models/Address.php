...
class Address {
    ...
    public static function create() {
        ...
        if (isset($_POST['create'])) {
            ...
            $stmt->bind_param('sssssi', $street_address, $city, $province, $postal_code, $country, $user_id);
            $stmt->execute();
    ...
    //NOT INTENDED TO USE BASED ON WIREFRAME...HOWEVER, WE WILL SEE
    public static function delete() {
        ...
        if (isset($_POST['delete'])) {
            ...
            // Validate $address_id (ensure it's a positive integer, for example)
